...
public interface EmployeeModelRespository extends JpaRepository<EmployeeModel,Long> {

    EmployeeModel findById(long id);
//    hw_admin_employee_model
    @Override
    void deleteById(Long aLong);

//    @Query(nativeQuery = true, value =
//            "select * from hw_admin_employee_model  where email= :email  or telephone= :email limit 1")
//    EmployeeModel findByEmailOrTelephoneParamsNative( @Param("email") String email);
//
//
